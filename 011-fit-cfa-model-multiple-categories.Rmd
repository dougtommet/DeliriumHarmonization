...
```
```{r}
drs.par <- readModels("cfa-drs-3.out")$parameters$unstandardized
...
```{r}
mdas.par <- readModels("cfa-mdas-3.out")$parameters$unstandardized
...
```{r}
cam.par <- readModels("cfa-cam-3.out")$parameters$unstandardized
