...
param <- readModels("cfa-drs-2-1-2pl.out")$parameters$unstandardized
mc.param <- param %>%
...
param <- readModels("cfa-mdas-2-1-2pl.out")$parameters$unstandardized
mc.param <- param %>%
  filter(paramHeader=="F.BY" | 
         paramHeader=="Thresholds" |
         (paramHeader=="Variances" & param=="F")) %>%
...
param <- readModels("cfa-cam-2-1-2pl.out")$parameters$unstandardized
mc.param <- param %>%
  filter(paramHeader=="F.BY" | 
         paramHeader=="Thresholds" |
         (paramHeader=="Variances" & param=="F")) %>%
