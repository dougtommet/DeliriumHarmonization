...
fit.2pl <- function(x, y, instrument, modeltype, use.variables1, use.variables2, st.analysis, st.variable, savefscores){
  ...
  param <- readModels(paste0("cfa-", instrument, "-1-", y, "-", modeltype, ".out"), quiet = TRUE)$parameters$unstandardized
  mc.param <- param %>%
...
Model 2
```{r}
readModels("cfa-drs-2-1-wlsmv.out", quiet = TRUE)$summaries %>%
  select(Observations, CFI, RMSEA_Estimate) %>%
  kable(digits=2, col.names = c("N", "CFI", "RMSEA")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, position = "left")
...
Model 1
```{r}
readModels("cfa-mdas-1-1-wlsmv.out", quiet = TRUE)$summaries %>%
  select(Observations, CFI, RMSEA_Estimate) %>%
  kable(digits=2, col.names = c("N", "CFI", "RMSEA")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, position = "left")
...
Model 2
```{r}
readModels("cfa-mdas-2-1-wlsmv.out", quiet = TRUE)$summaries %>%
  select(Observations, CFI, RMSEA_Estimate) %>%
  kable(digits=2, col.names = c("N", "CFI", "RMSEA")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, position = "left")
...
Model 1
```{r}
readModels("cfa-cam-1-1-wlsmv.out", quiet = TRUE)$summaries %>%
  select(Observations, CFI, RMSEA_Estimate) %>%
  kable(digits=2, col.names = c("N", "CFI", "RMSEA")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, position = "left")
...
Model 2
```{r}
readModels("cfa-cam-2-1-wlsmv.out", quiet = TRUE)$summaries %>%
  select(Observations, CFI, RMSEA_Estimate) %>%
  kable(digits=2, col.names = c("N", "CFI", "RMSEA")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), 
                full_width = F, position = "left")
