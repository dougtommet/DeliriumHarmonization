...
# df1 <- data.frame(a = rnorm(5), b = rnorm(5, 10))
# df2 <- data.frame(a = rnorm(5), b = rnorm(5, 10))
# df3 <- data.frame(a = rnorm(5), b = rnorm(5, 10))
# sim_list <- list(df1, df2, df3)
# 
# myfunction <- function(x) {
#   mean(x[,1], na.omit=TRUE)
#   
# }
# map(sim_list, myfunction)
...
## DRS
use.variables1.drs <- c("recordid", "studyidnum", "rdrs01", "rdrs02", "rdrs07", "rdrs08", 
                     "rdrs09", "rdrs10", "rdrs11")
use.variables2.drs <- c("rdrs03", "rdrs04", "rdrs05", "rdrs06", "rdrs12", "rdrs13")
...
Model 1
```{r}
item.parameter.table("cfa-drs-1-1-2pl.out", 7)
```
...
Model 1
```{r}
item.parameter.table("cfa-mdas-1-1-2pl.out", 7)
```
...
Model 1
```{r}
item.parameter.table("cfa-cam-1-1-2pl.out", 7)
```
