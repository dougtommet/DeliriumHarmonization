...
foo.drs<-  drs.par.poly %>%
  ...
  arrange(itemnum, B) %>%
  rename(A = A.drs) %>%
  mutate(gr.order = recode(itemnum, "1=1; 10=2; 12=3; 11=4; 9=7; 6=8; 5=9; 13=10; 2=12; 7=14; 8=15; 3=16; 4=17;"),
         test = "DRS") 
...
foo.mdas<-  mdas.par.poly %>%
  ...
  arrange(itemnum, B) %>%
  rename(A = A.mdas) %>%
  mutate(gr.order = recode(itemnum, "10=1; 5=2; 3=4; 4=5; 2=7; 6=8; 1=11; 7=12; 9=13; 8=16;"),
...
foo.cam<-  cam.par.poly %>%
  ...
  arrange(itemnum, B) %>%
  rename(A = A.cam) %>%
  mutate(gr.order = recode(itemnum, "10=1; 2=2; 6=4; 1=6; 5=7; 3=8; 4=11; 7=12; 8=14; 9=15;"),
         gr.order = gr.order+.5,
         test = "CAM",
         itemnum = itemnum+30) 
